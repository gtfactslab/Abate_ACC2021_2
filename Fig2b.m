...
%               reduced, via the application of Theorem 1 (30 times) with
%               different shape matrixes.  The shape matrixes used are
%               stored in the data set fig2b_T_set.mat, which is provided.
...
[Q1, Q2] = meshgrid(-.1:.01:2.6, .5:.01:2.5);
collect = [Q1(:), Q2(:)]';
