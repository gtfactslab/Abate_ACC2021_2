...
% Date: 9/27/2020
% Description:  This script generates Figure 4b.
...
T_1 = [cos(-pi/6)*(2*cos(pi/6)), cos(pi/3); ...
       sin(-pi/6)*(2*cos(pi/6)), sin(pi/3)]
T_2 = [1, 0; ...
       0, (2*cos(pi/6))]
T_3 = [cos(pi/6)*(2*cos(pi/6)), cos(2*pi/3); ...
       sin(pi/6)*(2*cos(pi/6)), sin(2*pi/3)]
global T
for i = 1:3
    if i == 1
        T = T_1; 
...
%matlab2tikz('F4b.tikz', 'width', '6cm', 'height', '4cm')
